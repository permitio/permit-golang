...
func (e *Environments) List(ctx context.Context, page int, perPage int) ([]openapi.EnvironmentRead, error) {
...
func (e *Environments) Get(ctx context.Context, environmentKey string) *openapi.EnvironmentRead {
	err := e.LazyLoadContext(ctx)
	if err != nil {
		e.logger.Error("", zap.Error(err))
	}
...
func (e *Environments) GetByKey(ctx context.Context, environmentKey string) *openapi.EnvironmentRead {
	return e.Get(ctx, environmentKey)
}

func (e *Environments) GetById(ctx context.Context, environmentId uuid.UUID) *openapi.EnvironmentRead {
	return e.Get(ctx, environmentId.String())
}

func (e *Environments) Create(ctx context.Context, environmentCreate openapi.EnvironmentCreate) *openapi.EnvironmentRead {
	err := e.LazyLoadContext(ctx)
	if err != nil {
		e.logger.Error("", zap.Error(err))
	}
...
func (e *Environments) Update(ctx context.Context, environmentKey string, environmentUpdate openapi.EnvironmentUpdate) *openapi.EnvironmentRead {
	err := e.LazyLoadContext(ctx)
	if err != nil {
		e.logger.Error("", zap.Error(err))
	}
