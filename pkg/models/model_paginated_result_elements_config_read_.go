...
// NewPaginatedResultElementsConfigRead instantiates a new PaginatedResultElementsConfigRead object
...
// NewPaginatedResultElementsConfigReadWithDefaults instantiates a new PaginatedResultElementsConfigRead object
...
func (o *PaginatedResultElementsConfigRead) GetData() []ElementsConfigRead {
	if o == nil {
		var ret []ElementsConfigRead
		return ret
	}
...
func (o *PaginatedResultElementsConfigRead) GetDataOk() ([]ElementsConfigRead, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *PaginatedResultElementsConfigRead) SetData(v []ElementsConfigRead) {
	o.Data = v
}
...
type NullablePaginatedResultElementsConfigRead struct {
	value *PaginatedResultElementsConfigRead
	isSet bool
}

func (v NullablePaginatedResultElementsConfigRead) Get() *PaginatedResultElementsConfigRead {
	return v.value
}

func (v *NullablePaginatedResultElementsConfigRead) Set(val *PaginatedResultElementsConfigRead) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedResultElementsConfigRead) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedResultElementsConfigRead) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedResultElementsConfigRead(val *PaginatedResultElementsConfigRead) *NullablePaginatedResultElementsConfigRead {
	return &NullablePaginatedResultElementsConfigRead{value: val, isSet: true}
}

func (v NullablePaginatedResultElementsConfigRead) MarshalJSON() ([]byte, error) {
